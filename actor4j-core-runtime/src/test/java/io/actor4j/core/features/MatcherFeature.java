...
public class MatcherFeature {
	...
	@Test
	public void test() {
		matcher.apply(ActorMessage.create(null, -5, UUID.fromString("5ae55fff-d420-4c31-bbe7-0b18812766c2"), null));
		assertEquals(2134, postconditions[2]);
		assertEquals(-5, postconditions[0]);
		assertEquals(-5, postconditions[1]);
		matcher.apply(ActorMessage.create(null, -5, UUID.fromString("acefb4a4-b2a0-4641-8553-9a0ac12e282a"), null));
		assertEquals(2199, postconditions[2]);
		assertEquals(-5, postconditions[0]);
		assertEquals(-5, postconditions[1]);
		matcher.apply(ActorMessage.create(null, -5, UUID.fromString("218e064b-0b92-4f80-95b3-49002d1e9b46"), null));
		assertEquals(2199, postconditions[2]);
		assertEquals(-5, postconditions[0]);
		assertEquals(-5, postconditions[1]);
		matcher.apply(ActorMessage.create(null, -8, null, null));
		...
		matcher.apply(ActorMessage.create(null, 22, UUID.fromString("4cd883bb-b2b0-4e98-bf53-416e38334a12"), null));
		assertEquals(187, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(22, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 25, UUID.fromString("26899da9-a339-41be-9969-e730fd880cae"), null));
		assertEquals(195, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(25, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 25, UUID.fromString("18a06a5f-b227-452e-a948-908f4e619074"), null));
		assertEquals(195, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(25, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 127, UUID.fromString("7ed0c429-5536-4ee8-9c84-52384cb24047"), null));
		assertEquals(1872, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(127, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 129, UUID.fromString("7ed0c429-5536-4ee8-9c84-52384cb24047"), null));
		assertEquals(1872, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(129, postconditions[1]);
		
		matcher.apply(ActorMessage.create(null, 327, UUID.fromString("e6ce694f-653e-4965-b1ba-c0a0166eff92"), null));
		assertEquals(18725, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(327, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 329, UUID.fromString("e6ce694f-653e-4965-b1ba-c0a0166eff92"), null));
		assertEquals(18725, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(329, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 327, UUID.fromString("720776f3-93d0-45b7-b0af-58465c2a4ac0"), null));
		assertEquals(18725, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(327, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 329, UUID.fromString("720776f3-93d0-45b7-b0af-58465c2a4ac0"), null));
		assertEquals(18725, postconditions[2]);
		assertEquals(10, postconditions[0]);
		assertEquals(329, postconditions[1]);
		
		matcher.apply(ActorMessage.create(null, -5, null, null));
		assertEquals(-5, postconditions[0]);
		assertEquals(-5, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 15, null, null));
		assertEquals(15, postconditions[0]);
		assertEquals(15, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 17, null, null));
		assertEquals(17, postconditions[0]);
		assertEquals(17, postconditions[1]);
		matcher.apply(ActorMessage.create(null, 235, null, null));
		assertEquals(235, postconditions[0]);
		assertEquals(235, postconditions[1]);
		matcher.apply(ActorMessage.create("", 235, null, null));
		assertEquals(1976, postconditions[0]);
		assertEquals(235, postconditions[1]);
		matcher.apply(ActorMessage.create("Hello World!", 235, null, null));
