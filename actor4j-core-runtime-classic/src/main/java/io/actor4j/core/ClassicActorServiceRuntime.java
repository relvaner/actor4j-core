...
import io.actor4j.core.runtime.classic.ClassicDefaultActorSystemImpl;

public class ClassicActorServiceRuntime {
	public static ActorSystemFactory factory() {
		return (c) -> new ClassicDefaultActorSystemImpl(ActorServiceConfig.builder(c).watchdogEnabled(false).build());
	}
